...
CREATE TABLE `tm_forgot_password` (
  ...
  CONSTRAINT `forgot_to_login` FOREIGN KEY (`tm_login_id`) REFERENCES `tm_login` (`tm_login_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tm_login` (
  `tm_login_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
