        ...
        <div class="mdk-header-layout__content page-content ">
            ...
            <div class="bg-gradient-primary border-bottom-white py-32pt">
                <div class="container d-flex flex-column flex-md-row align-items-center text-center text-md-left">
                    <img src="assets/tealdark/images/illustration/student/128/white.svg" width="104" class="mr-md-32pt mb-32pt mb-md-0" alt="student">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        ...
                                        <a class="card mb-0" href="">
                                            <img src="assets/tealdark/images/achievements/flinto.png" alt="Flinto" class="card-img" style="max-height: 100%; width: initial;">
                                            ...
                                            <span class="card-body fullbleed">
                                                <span class="row">
                                                    <span class="col-5 text-center">
                                                        ...
                                                        <img src="assets/tealdark/images/illustration/achievement/128/white.png" alt="achievement">
                                                    </span>
                                                    <span class="col-7 d-flex flex-column">
                                                        <span class="text-right flex">
                                                            <img src="assets/tealdark/images/paths/flinto_40x40@2x.png" width="64" alt="Flinto" class="rounded">
                                                        </span>
                                                        <span>
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <a class="card mb-0" href="">
                                            <img src="assets/tealdark/images/achievements/angular.png" alt="Angular fundamentals" class="card-img" style="max-height: 100%; width: initial;">
                                            <div class="fullbleed bg-primary" style="opacity: .5;"></div>
                                            <span class="card-body fullbleed">
                                                <span class="row">
                                                    <span class="col-5 text-center">
                                                    ...
                                                    <span class="col-7 d-flex flex-column">
                                                        <span class="text-right flex">
                                                            <img src="assets/tealdark/images/paths/angular_40x40@2x.png" width="64" alt="Angular fundamentals" class="rounded">
                                                        </span>
                                                        <span>
                                        ...
                                        <div class="flex">
                                            <div class="d-flex align-items-center">
                                                <div class="rounded mr-16pt z-0 o-hidden">
                                                    <div class="overlay">
                                                        <img src="assets/tealdark/images/paths/angular_40x40@2x.png" width="40" height="40" alt="Angular" class="rounded">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex">
                                            <div class="d-flex align-items-center">
                                                <div class="rounded mr-16pt z-0 o-hidden">
                                                    <div class="overlay">
                                                        <img src="assets/tealdark/images/paths/swift_40x40@2x.png" width="40" height="40" alt="Angular" class="rounded">
                                                        <span class="overlay__content overlay__content-transparent">
                                                            <span class="overlay__action d-flex flex-column text-center lh-1">
                                                                <small class="h6 small text-white mb-0" style="font-weight: 500;">80%</small>
                                                            </span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex">
                                            <div class="d-flex align-items-center">
                                                <div class="rounded mr-16pt z-0 o-hidden">
                                                    <div class="overlay">
                                                        <img src="assets/tealdark/images/paths/react_40x40@2x.png" width="40" height="40" alt="Angular" class="rounded">
                                                        <span class="overlay__content overlay__content-transparent">
                                                            <span class="overlay__action d-flex flex-column text-center lh-1">
                                                                <small class="h6 small text-white mb-0" style="font-weight: 500;">80%</small>
                                                            </span>
                                    ...
                                    <div class="mdk-carousel__content">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal " data-partial-height="40" data-toggle="popover" data-trigger="click">
                                                ...
                                                <a href="student-take-course.html" class="js-image" data-position="">
                                                    <img src="assets/tealdark/images/paths/angular_430x168.png" alt="course">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal " data-partial-height="40" data-toggle="popover" data-trigger="click">
                                                ...
                                                <a href="student-take-course.html" class="js-image" data-position="">
                                                    <img src="assets/tealdark/images/paths/swift_430x168.png" alt="course">
                                                    <span class="overlay__content">
                                                        <span class="overlay__action d-flex flex-column text-center">
                                                            <i class="material-icons">play_circle_outline</i>
                                                            <small>Resume course</small>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal " data-partial-height="40" data-toggle="popover" data-trigger="click">
                                                ...
                                                <a href="student-take-course.html" class="js-image" data-position="">
                                                    <img src="assets/tealdark/images/paths/wordpress_430x168.png" alt="course">
                                                    <span class="overlay__content">
                                                        <span class="overlay__action d-flex flex-column text-center">
                                                            <i class="material-icons">play_circle_outline</i>
                                                            <small>Resume course</small>
                                            ...
                                            <div class="popoverContainer d-none">
                                                <div class="media">
                                                    <div class="media-left">
                                                        <img src="assets/tealdark/images/paths/wordpress_40x40@2x.png" width="40" height="40" alt="Angular" class="rounded">
                                                    </div>
                                                    <div class="media-body">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="card card--elevated card-course overlay js-overlay mdk-reveal js-mdk-reveal " data-partial-height="40" data-toggle="popover" data-trigger="click">
                                                ...
                                                <a href="student-take-course.html" class="js-image" data-position="left">
                                                    <img src="assets/tealdark/images/paths/react_430x168.png" alt="course">
                                                    <span class="overlay__content">
                                                        <span class="overlay__action d-flex flex-column text-center">
                                                            <i class="material-icons">play_circle_outline</i>
                                                            <small>Resume course</small>
                                    ...
                                    <div class="col-md-3 mb-8pt mb-md-0">
                                        <div class="media">
                                            <div class="media-left mr-16pt">
                                                <a href="student-profile.html"><img src="assets/tealdark/images/people/110/guy-1.jpg" width="40" alt="avatar" class="rounded-circle"></a>
                                            </div>
                            ...
                            <div class="list-group-item p-3">
                                <div class="row align-items-center">
                                    <div class="col-md-3 mb-8pt mb-md-0">
                                        <div class="media">
                                            <div class="media-left mr-16pt">
                                                <a href="student-profile.html"><img src="assets/tealdark/images/people/110/guy-2.jpg" width="40" alt="avatar" class="rounded-circle"></a>
                                            </div>
                                            <div class="media-body media-middle">
